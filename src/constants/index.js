...
const experiences = [
  {
    ...
    points: [
      ...
      "Assisted in the creation and maintenance of visually captivating web pages, utilizing Webflow's powerful design and animation tools to enhance user experience and engagement.",
      "Implemented best practices for SEO optimization and accessibility, ensuring websites are search engine friendly and inclusive to all users.",
  ...
  },
  {
    ...
    points: [
      "Gained hands-on experience in front-end with backend programming languages and tools such as Node.js and using databases such as MongoDB.",
      "Created and optimized web applications, utilizing front-end frameworks like React and back-end frameworks like Express.",
